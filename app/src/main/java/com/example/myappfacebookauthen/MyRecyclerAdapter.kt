...
class MyRecyclerAdapter (context: Context,fm: FragmentManager, val dataSource: JSONArray) : RecyclerView.Adapter<MyRecyclerAdapter.Holder>() {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.layout.setOnClickListener{
            ...
            val detail:String = dataSource.getJSONObject(position).getString("ingredientLines").toString()

            val item_selected = item_selected().newInstance(head,body,img,detail)
